    ...
    Swal.fire({
      ...
      html: `
        <div style="text-align: left; padding: 10px;">
          ...
          <p>Our team at <strong>Divijix Technologies Pvt. Ltd.</strong> is currently preparing a comprehensive solutions brochure and detailed case studies for this sector.</p>
